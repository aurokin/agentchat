...
- Per-object / per-user: `AGENTCHAT_MAX_ATTACHMENT_BYTES`, `AGENTCHAT_MAX_CHATS_PER_USER`, `AGENTCHAT_MAX_ATTACHMENTS_PER_MESSAGE`, `AGENTCHAT_MAX_MESSAGES_PER_USER`, `AGENTCHAT_MAX_USER_TOTAL_ATTACH_BYTES`
- Query: `AGENTCHAT_MAX_LIST_CHATS`, `AGENTCHAT_MAX_LIST_MESSAGES`, `AGENTCHAT_MAX_LIST_ATTACHMENTS`

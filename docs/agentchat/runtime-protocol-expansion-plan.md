...
Runtime expansion should proceed abstraction-first:

1. harden the shared runtime adapter contract
...
persistent conversation runtimes and per-turn subprocess runtimes.
...
### AUR-140 KindRuntime Contract V2

Harden the adapter contract before adding another runtime kind.

Expected outcomes:

- generic runtime capabilities
- generic runtime binding metadata

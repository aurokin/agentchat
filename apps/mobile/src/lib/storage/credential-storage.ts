...
export async function getAuthToken(): Promise<string | null> {
    try {
        const value = await getItemAsync(CREDENTIAL_KEYS.AUTH_TOKEN);
        return value;
    } catch {
        return null;
    }
...
export async function setAuthToken(token: string): Promise<void> {
    try {
        await setItemAsync(CREDENTIAL_KEYS.AUTH_TOKEN, token);
    } catch (error) {
...
export async function clearAuthToken(): Promise<void> {
    try {
        await deleteItemAsync(CREDENTIAL_KEYS.AUTH_TOKEN);
    } catch (error) {
...
export async function getRefreshToken(): Promise<string | null> {
    try {
        const value = await getItemAsync(CREDENTIAL_KEYS.REFRESH_TOKEN);
        return value;
    } catch {
        return null;
    }
...
export async function setRefreshToken(token: string): Promise<void> {
    try {
        await setItemAsync(CREDENTIAL_KEYS.REFRESH_TOKEN, token);
    } catch (error) {
...
export async function clearRefreshToken(): Promise<void> {
    try {
        await deleteItemAsync(CREDENTIAL_KEYS.REFRESH_TOKEN);
    } catch (error) {
        console.error(
